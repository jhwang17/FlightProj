        ...
        EventHandler<MouseEvent> signupEvent = new EventHandler<MouseEvent>() {
    		...
    		public void handle(MouseEvent e) {
    			if(e.getButton() == MouseButton.PRIMARY) {
    				try {
    					while(true) {
    						if (firstNameF.getText().isEmpty() || lastNameF.getText().isEmpty() || streetF.getText().isEmpty()   									
    							|| cityF.getText().isEmpty() || stateF.getText().isEmpty() || zipCodeF.getText().isEmpty()
    							|| emailF.getText().isEmpty() || ssnF.getText().isEmpty() || userNameF.getText().isEmpty() 
    							|| passwordF.getText().isEmpty() || securityQuestionF.getText().isEmpty() || securityAnswerF.getText().isEmpty()) {
   								...
   								break;
    								...
    								for(Customer c:customers) {
    									if(c.getIdCustomer() == Integer.parseInt(userNameF.getText())) {
    										marker = 1;
    										break;
    									}
    								}
    								...
    								Customer customer = new Customer(Integer.parseInt(userNameF.getText()), firstNameF.getText(), 
    																				 lastNameF.getText(), streetF.getText(),stateF.
    																				 getText(), cityF.getText(), zipCodeF.getText(), 
    																				 emailF.getText(), ssnF.getText(), userNameF.getText(),
    																				 passwordF.getText(),securityQuestionF.getText(),
    																				 securityAnswerF.getText()); 
